$('.search-button').on('click', function(){
    $.ajax({
        url:'http://www.omdbapi.com/?i=tt3896198&apikey=f7b84954&s=' + $('.input-keyword').val(),
        success : results =>{
            ...
            $('.modal-detail-button').on('click', function(){
                $.ajax({
                    url: 'http://www.omdbapi.com/?i=tt3896198&apikey=f7b84954&s=avengers' + $(this).data('imdbid'),
                    success: m=>{
        ...
        <div class="col-md">
            <ul class="list-group">
                <li class="list-group-item">
                    <h4> ${m.Ttile} ${m.Year}</h4>
                </li>
                <li class="list-group-item"><STRONG>Director : ${m.Director}</STRONG></li>
                <li class="list-group-item"><strong>Actor : ${m.Aosters}</strong></li>
